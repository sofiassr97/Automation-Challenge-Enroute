...
exports.config = {
  ...
  // - @wdio/applitools-service, @wdio/browserstack-service, @wdio/
  //     devtools-service, @wdio/sauce-service
  ...
  // },
  /**
     * Gets executed just before initialising the webdriver session & test framework. It allows you
  ...
  before: function before(capabilities, specs) {
    ...
    */
    ...
    global.browser.setWindowSize(1600, 900);
    global.TIMEOUTS = {
      fast: 5000,
      medium: 10000,
      slow: 15000,
    ...
    global.enableFailureScreenshots = false;
  },
